...
Maritime Operations is a **single-page reference**, not a course. It scopes the abstract maritime concepts from MOF-101/MOT-101 down to one concrete region — Puget Sound — across five sections:
...
4. **Industry & Economic Case Studies** — five sourced, stat-backed case studies strictly scoped to Washington State/Puget Sound: NWSA/Port of Seattle-Tacoma economic impact vs. cargo diversion to Vancouver/Prince Rupert, the 2021–22 congestion crisis as it hit Puget Sound specifically, WSF's funding and workforce crisis and its ripple effect on ferry-dependent communities, the pilotage-as-utility rate structure and its regulatory-headcount chokepoint, and the August 2024 Port of Seattle ransomware attack tied back to the companion Maritime OT site's IT/OT territory. (Global container-shipping economics — carrier alliances, freight rate cycles, Red Sea/Suez disruption — live on the separate [global maritime industry primer](https://clarkngo.github.io/playground/primer/industry/maritime/index.html), not here.)

## Structure

| Path | Purpose |
|------|---------|
| `index.html` | The full single-page site (all five sections) |
| `css/style.css` | Dark-navy / cyan visual identity, off-white content cards, scroll-reveal + flow animations, stat/case-study components |
